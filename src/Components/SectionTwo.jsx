        ...
        <section className="bg-black relative z-50 pb-12">
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div className="flex flex-col justify-center items-start space-y-3 border-l-2 border-b-2 border-sky-700 p-4">
                        <p data-aos="fade-up" className="text-sky-800 text-xl uppercase font-thin">
                            Our Mission
                        </p>
                        ...
                        <button data-aos="fade-up" data-aos-delay="600" className="text-white bg-blue-400 px-5 py-3 rounded-md hover:bg-blue-500 transition-all duration-200">
                            Learn More
                        </button>
                    </div>
